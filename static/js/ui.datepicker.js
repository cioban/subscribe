...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		prevStatus: 'Mostrar Anterior', // Status text for previous month link
		nextText: 'Próximo', // Display text for next month link
		nextStatus: 'Mostrar próximo mês', // Status text for next month link
		currentText: 'Hoje', // Display text for current month link
		currentStatus: 'Mostrar mês atual', // Status text for current month link
